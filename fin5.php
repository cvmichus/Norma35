                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                     ...
                     <CENTER><h1> GRACIAS POR TU VALIOSO TIEMPO AL TOMAR ESTE CUESTIONARIO , SALUDOS</h1>
                           <BR><BR><BR>
                           <?php
                            $sql0 = "{call sp_INC_NOM35_SeGuardoAcuseG5 (?)}";
                            $param0 = array(array($Codigousuario, SQLSRV_PARAM_IN));
                            $qry0 = sqlsrv_query($con,$sql0,$param0);
                            $data0 = sqlsrv_fetch_object($qry0);
                            $visible = $data0->AcuseG5;
                      if($visible == 1){
                    ...
                    <div style="<?php echo $varvisible; ?>">
                        <h2 class="card-title">ACUSE DE APLICACION DE GUIA DE REFERENCIA V</h2> 
...
$(document).ready( function() {   // Esta parte del código se ejecutará automáticamente cuando la página esté lista.
    $("#botonenviar").click( function() {     // Con esto establecemos la acción por defecto de nuestro botón de enviar.
        if(validaForm()){                               // Primero validará el formulario.
            $.post("GuardaAcuse5.php",$("#formdata").serialize(),function(res){
